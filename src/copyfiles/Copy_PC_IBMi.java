            ...
            try {
                ...
                // ========================================================
                    ...
                    // PC file to save file 
                        ...
                        && targetPathString.endsWith(".FILE") && targetPath.getSubtype().equals("SAVF")) {
                    // Target save file has type .FILE in the IFS notation and has suffix .SAVF in the visible tree structure
